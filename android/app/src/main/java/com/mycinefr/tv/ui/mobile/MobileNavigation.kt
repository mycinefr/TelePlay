...
import com.mycinefr.tv.ui.mobile.auth.MobileLoginScreen
import com.mycinefr.tv.ui.mobile.home.MobileHomeScreen
import com.mycinefr.tv.ui.mobile.player.MobilePlayerScreen
...
sealed class BottomNavItem(
    ...
    object Home : BottomNavItem("home", "Accueil", Icons.Filled.Home, Icons.Outlined.Home)
    object Search : BottomNavItem("search", "Recherche", Icons.Filled.Search, Icons.Outlined.Search)
    object Downloads : BottomNavItem("downloads", "Téléchargements", Icons.Filled.Download, Icons.Outlined.Download)
}
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(BottomNavItem.Search.route) {
                com.mycinefr.tv.ui.mobile.search.MobileSearchScreen(
                    onPlayFile = onNavigateToPlayer,
            ...
            composable(BottomNavItem.Downloads.route) {
                com.mycinefr.tv.ui.mobile.downloads.MobileDownloadsScreen()
            }
        }
    }
}
